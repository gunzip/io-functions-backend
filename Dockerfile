...
COPY /openapi/notifications.yaml /usr/src/app/openapi/notifications.yaml
COPY /openapi/backend.yaml /usr/src/app/openapi/backend.yaml
COPY /openapi/pagopa.yaml /usr/src/app/openapi/pagopa.yaml
COPY /openapi/public.yaml /usr/src/app/openapi/public.yaml
